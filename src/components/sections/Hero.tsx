...
const Hero: React.FC = () => {
  ...
  return (
    <section id="inicio" className="hero">
      ...
      <div className="hero-main-container">
        ...
        <div className="hero-content">
          ...
          <p className="hero-description">
            Desarrollador de software con pensamiento creativo.
            Me apasiona crear soluciones tecnológicas desde cero,
            combinando diseño, funcionalidad y buenas prácticas
            para desarrollar productos modernos, eficientes y
            fáciles de usar.
          </p>
      ...
      {/* =====================================
          ROBOT + BURBUJA RETRO DEL CHATBOT
      ====================================== */}
      <div
      ...
      >
        ...
        <div
          ...
          aria-hidden={!chatbotOpen}
        >
          <div className="chatbot-tooltip-inner">

            <span className="chatbot-line chatbot-line-1">
              <span className="message-cursor">›</span>
              ¡Hola! 👋
            </span>

            <span className="chatbot-line chatbot-line-2">
              Puedes hablar conmigo
            </span>

            <span className="chatbot-line chatbot-line-3">
